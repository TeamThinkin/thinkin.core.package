...
public static class CodewordGenerator
{
    ...
    {
        var animal = _animals[Random.Range(0, _animals.Length)].ToLower();
        var firstLetter = animal[0].ToString();
        var filteredAdjectives = _adjectives.Where(i => i.StartsWith(firstLetter));
        var adjective = filteredAdjectives.Skip(Random.Range(0, filteredAdjectives.Count())).First();
    ...
    public static string GetPlace()
    {
        ...
        var place = _places[Random.Range(0, _places.Length)];
    ...
    private static string[] _places = new[]
    {
        "house",
        "room",
        "lair",
